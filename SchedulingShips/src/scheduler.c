...
void set_scheduling_workflow_parameters(int CHANNEL_SIZE_DEFINED, int MAX_SHIPS_DEFINED, int EQUITY_W_DEFINED, int SIGN_TIME_DEFINED, int QUANTUM_DEFINED){
    CHANNEL_SIZE = CHANNEL_SIZE_DEFINED;
    MAX_SHIPS = MAX_SHIPS_DEFINED;
    EQUITY_W = EQUITY_W_DEFINED;
    SIGN_TIME = SIGN_TIME_DEFINED;
    QUANTUM = QUANTUM_DEFINED;
}
